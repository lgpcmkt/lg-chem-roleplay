    ...
    <div className="absolute inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white text-slate-800 w-full max-w-sm rounded-[32px] p-8 shadow-2xl animate-fadeIn">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-8">
          <div className="w-20 h-20 bg-indigo-100 text-indigo-600 rounded-[24px] flex items-center justify-center text-3xl mb-2 shadow-inner border border-indigo-200">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4">
          <div className="space-y-3">
            <input 
              ...
              autoFocus
              className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-[15px] font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-400 focus:bg-white transition-colors" 
            />
            <input 
              type="text" 
              value={nameInput} 
          ...
          <button 
            type="submit" 
            className="w-full py-4 mt-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold flex items-center justify-center gap-2 text-lg transition-all active:scale-[0.98] shadow-md"
          >
            <span>시작하기</span>
