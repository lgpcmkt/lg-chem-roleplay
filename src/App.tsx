...
const SCENARIOS: Record<string, Scenario[]> = {
  zemidapa: [
    ...
    { id: 'z2', title: '에스글리토 선호 고객', name: '이학술 교수', description: '', difficulty: '고급', personaImage: '/images/waiting_room_hospital.png', hashtags: ['#스위칭연구', '#혈당강하 효과', '#작은 약제크기'], missionMsg: '에스글리토 선호 고객에게 제미다파의 임상 데이터를 설명하고, 처방을 유도해내세요!' },
  ...
  vimovo: [
    ...
    { id: 'v2', title: '쎄레브렉스 선호 고객', name: '최안전 교수', description: '', difficulty: '고급', personaImage: '/images/waiting_room_hospital.png', hashtags: ['#복합제이점', '#심혈관안전성', '#오리지널'], missionMsg: '쎄레브렉스 선호 교수에게 비모보의 위장관 안전성을 설명하고, 처방을 유도해내세요!' },
