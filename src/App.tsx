...
const PRODUCTS: Record<string, Product> = {
  zemidapa: {
    ...
    specialties: [
      { id: 'cardio', name: '순환기내과', icon: '❤️', imageUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=300&q=80', description: 'SGLT-2i 심혈관 보호 관점' },
      { id: 'endocrine', name: '내분비내과', icon: '🔬', imageUrl: 'https://images.unsplash.com/photo-1579154204601-01588f351e67?w=300&q=80', description: '당뇨 혈당 조절 전문' },
      { id: 'nephro', name: '신장내과', icon: '🫘', imageUrl: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=300&q=80', description: 'eGFR/신장 보호 관점' },
    ],
  },
  vimovo: {
    ...
    specialties: [
      { id: 'rheumatology', name: '류마티스내과', icon: '🦴', imageUrl: 'https://images.unsplash.com/photo-1576089172869-4f5f6f315620?w=300&q=80', description: '류마티스/골관절염 전문' },
      { id: 'orthopedics', name: '정형외과', icon: '🏥', imageUrl: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=300&q=80', description: '근골격계 통증 관리' },
      { id: 'neurology', name: '신경과', icon: '🧠', imageUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=300&q=80', description: '통증/신경 질환 관점' },
    ],
  },
  nephoxil: {
    ...
    specialties: [
      { id: 'nephro_ckd', name: '신장내과', icon: '🫘', imageUrl: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?w=300&q=80', description: '투석 환자 인/철분 관리' },
      { id: 'endocrine_ckd', name: '내분비내과', icon: '🔬', imageUrl: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300&q=80', description: 'CKD 대사 합병증 관리' },
      { id: 'general_internal', name: '일반내과', icon: '🩺', imageUrl: 'https://images.unsplash.com/photo-1527613426496-2287bf6236b2?w=300&q=80', description: '만성 질환 예방 관리' },
    ],
  },
};
